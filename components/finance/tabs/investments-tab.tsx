  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-surface-dark text-white rounded-2xl p-6 relative overflow-hidden shadow-lg">
          <div className="absolute top-0 right-0 -mr-8 -mt-8 w-32 h-32 bg-accent-green/20 rounded-full blur-2xl" />
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div>
              <p className="text-white/60 text-sm font-medium mb-1">Asset Classes</p>
              <h3 className="text-2xl font-medium">{new Set(investments.map(i => i.type)).size}</h3>
            </div>
            <div className="mt-4 flex items-center text-xs text-white/80 gap-1">
