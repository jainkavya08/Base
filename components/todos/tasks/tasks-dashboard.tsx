      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            ...
            size="sm"
            className={view === "list" ? "bg-accent-blue text-surface-card" : "border-border text-ink hover:bg-canvas bg-transparent"}
          ...
          <Button
            ...
            size="sm"
            className={view === "board" ? "bg-accent-blue text-surface-card" : "border-border text-ink hover:bg-canvas bg-transparent"}
          ...
          <Button
            ...
            size="sm"
            className={view === "compact" ? "bg-accent-blue text-surface-card" : "border-border text-ink hover:bg-canvas bg-transparent"}
